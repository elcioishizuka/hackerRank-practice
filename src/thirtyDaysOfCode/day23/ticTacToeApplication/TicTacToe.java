...
public class TicTacToe {
    ...
    public boolean playTurn(int spot){
        ...
        if (isValid) {
            board[spot-1] = currentMarker; // spot-1 in order to adjust UI (board starting at position 1) to the board array index
    ...
    public static boolean isSpotTaken(int number){
    ...
    public static void printAvailableSpots(){
        ...
        for (int i = 0; i < board.length; i++) {
            ...
            System.out.print(" | " + (isSpotTaken(i+1) ? " " : (i+1)));
        }
        System.out.println();
    }
